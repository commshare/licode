...
#include <chrono>
	...
	class cColouredConsoleListener
		: public zhangbin::cLogger::cListener
	{
	protected:
	
		virtual void SetLogColour(zhangbin::cLogger::eLogLevel a_LogLevel) = 0;
		virtual void SetDefaultLogColour() = 0;
	
		virtual void Log(AString a_Message, zhangbin::cLogger::eLogLevel a_LogLevel) override
		{
...
std::unique_ptr<zhangbin::cLogger::cListener> MakeConsoleListener(bool a_IsService)
{
	if (a_IsService)
	{
...
std::pair<bool, std::unique_ptr<zhangbin::cLogger::cListener>> MakeFileListener()
{
